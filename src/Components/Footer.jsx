...
function NavBar() {
  ...
  return (
    <>
    <section className='bg-[#6b4c17] flex text-[10px]'>
      <div className='flex flex-col gap-5 m-6 w-full'>

        <li className='flex gap-3 items-center'>
            <a href="https://facebook.com"><img src={instagramWhite} alt="" className='h-5' /></a>
            <a href="https://facebook.com"><img src={facebookWhite} alt="" className='h-[18px] ' /></a>
        </li>

        <section className='flex gap-10 border-y border-white/40 py-8'>
