    ...
    <section className='flex flex-col gap-8 text-[13px] border-t border-white/30 fira-sans-extralight'>
      <div className='flex flex-col gap-6 ml-5 my-6'>
        ...
        <section className='flex gap-3'>
          <img src={apple_pay} alt="" className='h-5' />
          <img src={american_express_pay} alt="" className='h-5' />
          <img src={paypal_pay} alt="" className='h-5' />
          <img src={mastercard_pay} alt="" className='h-5' />
          <img src={visa_pay} alt="" className='h-5' />
