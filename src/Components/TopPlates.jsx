  ...
  return (
    <>
      <div className='mb-20 mx-5 flex flex-col'>
              ...
              <section className='flex flex-col fira-sans-extralight mt-10 mb-10'>
                ...
                <section className='flex items-center gap-2 text-[10px] border-b pb-3 border-white/20 text-white/50 '>
                  ...
                  <span className='first-btn'><img src={Heart} className='h-3' alt="" /> 20% Dto.</span>
                  <span className='first-btn'><img src={Delivery} className='h-4' alt="" /> 20% Dto.</span>
                </section>
              </section>
